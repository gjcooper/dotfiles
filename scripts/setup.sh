...
install_sw () {
  ...
  sudo -E apt-get -y install curl vim gitk zsh tmux python3 ipython ipython3 dos2unix python-pip python3-pip i3 terminator suckless-tools lightdm dbus-x11 xsel dkms feh conky compton python3-venv python3-tk
